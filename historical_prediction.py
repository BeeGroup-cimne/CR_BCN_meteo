...
if __name__ == "__main__":
    ...
    lat_range = [40.5, 42.9]
    lon_range = [0.1, 3.4]
    ym_range = [202001, 202002]  # range that is going to be predicted formatted like YYYYMMDD
    n_harm = 4  # Nb of harmonics used for Fourier series, must match with n_harm used for model training
    model_name = 'cat_hist_8yrs_04_6_10_timespace'
    model_extension = '.cbm'
    ...
    df_final.write_parquet(f'{nextcloud_root_dir}/Historical_ERA5Land/Predictions/{final_file_name}.parquet')
